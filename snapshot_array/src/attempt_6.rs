...
// attempt 5 fails due to timeout on test case 73
// attempt 6 fails due to timeout on test case 72
...
struct SnapshotArray {
    snapshot_count: i32,
    values: HashMap<i32, SnapshotValue>,
}
...
impl SnapshotArray {
    ...
    fn set(&mut self, index: i32, val: i32) {
        self.values
            .entry(index)
            .and_modify(|v| v.current_val = val)
            .or_insert(SnapshotValue {
                current_val: val,
                histories: vec![],
            });
    }
